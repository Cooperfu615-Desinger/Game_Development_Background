...
export const tbdRegistry = [
    ...
    tbd('TBD-SEC-003', 'security', '高風險操作、核准、併發與稽核', '遊戲 Release 已採一般一人＋高風險第二人核准；待映射 permission、approval、併發、稽核，並另補風控與內容發布的實際規則。', ['Product', 'Security', 'Backend', 'SRE'], ['game-environments', 'game-settings', 'game-math', 'game-versions', 'game-assets', 'risk-alerts', 'website-banners', 'website-content', 'website-releases', 'lobby-management'], ['monitoring-risk', 'game-lifecycle', 'website-lobby'], ['frontend', 'backend', 'qa', 'release'], 'P0', 'partial', '高風險操作實作前'),
