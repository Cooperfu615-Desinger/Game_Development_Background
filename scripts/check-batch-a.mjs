...
assert(['0.9.0-batch-a-draft', '0.10.0-batch-b-draft', '0.11.0-batch-c-draft', '0.12.0-batch-d-draft', '0.13.0-phase-two-seal'].includes(book.version), '規格網站版本不得早於 Batch A Draft')
