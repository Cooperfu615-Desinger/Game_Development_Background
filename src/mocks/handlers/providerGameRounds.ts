...
function buildRound(seed: RoundSeed): ProviderGameRound {
    ...
    const win = new Big(seed.winPoints)
    ...
    return {
        ...
        win_points: win.toFixed(2),
        net_points: net.toFixed(2),
        bet_usdt: bet.div(rate).toFixed(2),
        win_usdt: win.div(rate).toFixed(2),
        net_usdt: net.div(rate).toFixed(2),
...
const mockGameRounds: ProviderGameRound[] = [
    buildRound({
        roundId: 'round-20260805-0098', externalRoundId: 'ggap-r-8f31a9', gameId: 'slot-orbit', gameName: '星際寶藏', gameType: 'slots', gameVersion: '3.8.1', releaseId: 'rel-20260718-03', agentId: 'agent-a031', agentName: '北辰娛樂代理', memberId: 'member-8e72a1', betPoints: '100', winPoints: '260', pointsPerUsdt: '100', startedAt: null, settledAt: '2026-08-05T15:18:42+08:00', createdAt: '2026-08-05T15:18:39+08:00', updatedAt: '2026-08-05T15:18:42+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260805-0097', externalRoundId: 'ggap-r-7c20dd', gameId: 'crash-solo', gameName: 'Skyline Crash', gameType: 'crash', gameVersion: '2.4.0', releaseId: 'rel-20260730-01', agentId: 'agent-b204', agentName: '曜石通路', memberId: 'member-19b44c', betPoints: '500', winPoints: '125', pointsPerUsdt: '100', startedAt: '2026-08-05T15:14:10+08:00', settledAt: '2026-08-05T15:14:18+08:00', createdAt: '2026-08-05T15:14:10+08:00', updatedAt: '2026-08-05T15:14:18+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260805-0096', externalRoundId: 'ggap-r-69b115', gameId: 'mini-burst', gameName: 'Mini Burst', gameType: 'crash', gameVersion: '1.9.2', releaseId: 'rel-20260712-02', agentId: 'agent-a031', agentName: '北辰娛樂代理', memberId: 'member-4af012', betPoints: '80', winPoints: '144', pointsPerUsdt: '80', startedAt: null, settledAt: '2026-08-05T15:07:03+08:00', createdAt: '2026-08-05T15:07:01+08:00', updatedAt: '2026-08-05T15:07:03+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260805-0095', externalRoundId: 'ggap-r-4e5f80', gameId: 'slot-crown', gameName: 'Crown of Fortune', gameType: 'slots', gameVersion: '4.1.0', releaseId: 'rel-20260726-04', agentId: 'agent-c118', agentName: '流光遊戲通路', memberId: 'member-770cd8', betPoints: '250', winPoints: '0', pointsPerUsdt: '100', startedAt: null, settledAt: '2026-08-05T14:52:27+08:00', createdAt: '2026-08-05T14:52:24+08:00', updatedAt: '2026-08-05T14:52:27+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260805-0094', externalRoundId: 'ggap-r-228a31', gameId: 'slot-neon', gameName: 'Neon Fruits', gameType: 'slots', gameVersion: '2.7.5', releaseId: 'rel-20260709-01', agentId: 'agent-b204', agentName: '曜石通路', memberId: 'member-31f08e', betPoints: '120', winPoints: '360', pointsPerUsdt: '100', startedAt: null, settledAt: '2026-08-05T14:31:56+08:00', createdAt: '2026-08-05T14:31:53+08:00', updatedAt: '2026-08-05T14:31:56+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260805-0093', externalRoundId: 'ggap-r-0ba7e2', gameId: 'crash-solo', gameName: 'Skyline Crash', gameType: 'crash', gameVersion: '2.4.0', releaseId: 'rel-20260730-01', agentId: 'agent-c118', agentName: '流光遊戲通路', memberId: 'member-6ab7f2', betPoints: '1000', winPoints: '1750', pointsPerUsdt: '100', startedAt: '2026-08-05T14:12:28+08:00', settledAt: '2026-08-05T14:12:45+08:00', createdAt: '2026-08-05T14:12:28+08:00', updatedAt: '2026-08-05T14:12:45+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260805-0092', externalRoundId: 'ggap-r-f1c4a6', gameId: 'slot-orbit', gameName: '星際寶藏', gameType: 'slots', gameVersion: '3.8.1', releaseId: 'rel-20260718-03', agentId: 'agent-a031', agentName: '北辰娛樂代理', memberId: 'member-0c72fe', betPoints: '50', winPoints: '20', pointsPerUsdt: '100', startedAt: null, settledAt: '2026-08-05T13:59:18+08:00', createdAt: '2026-08-05T13:59:16+08:00', updatedAt: '2026-08-05T13:59:18+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260805-0091', externalRoundId: 'ggap-r-c54d11', gameId: 'mini-burst', gameName: 'Mini Burst', gameType: 'crash', gameVersion: '1.9.2', releaseId: 'rel-20260712-02', agentId: 'agent-b204', agentName: '曜石通路', memberId: 'member-82a912', betPoints: '200', winPoints: '420', pointsPerUsdt: '80', startedAt: null, settledAt: '2026-08-05T13:44:05+08:00', createdAt: '2026-08-05T13:44:02+08:00', updatedAt: '2026-08-05T13:44:05+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260805-0090', externalRoundId: 'ggap-r-8d9a4c', gameId: 'slot-crown', gameName: 'Crown of Fortune', gameType: 'slots', gameVersion: '4.1.0', releaseId: 'rel-20260726-04', agentId: 'agent-c118', agentName: '流光遊戲通路', memberId: 'member-a340c1', betPoints: '300', winPoints: '210', pointsPerUsdt: '100', startedAt: null, settledAt: '2026-08-05T13:21:33+08:00', createdAt: '2026-08-05T13:21:31+08:00', updatedAt: '2026-08-05T13:21:33+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260805-0089', externalRoundId: 'ggap-r-771d08', gameId: 'slot-neon', gameName: 'Neon Fruits', gameType: 'slots', gameVersion: '2.7.5', releaseId: 'rel-20260709-01', agentId: 'agent-a031', agentName: '北辰娛樂代理', memberId: 'member-5a8b6d', betPoints: '75', winPoints: '105', pointsPerUsdt: '100', startedAt: null, settledAt: '2026-08-05T12:58:47+08:00', createdAt: '2026-08-05T12:58:44+08:00', updatedAt: '2026-08-05T12:58:47+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260805-0088', externalRoundId: 'ggap-r-5e21fb', gameId: 'crash-solo', gameName: 'Skyline Crash', gameType: 'crash', gameVersion: '2.4.0', releaseId: 'rel-20260730-01', agentId: 'agent-c118', agentName: '流光遊戲通路', memberId: 'member-2d6e9a', betPoints: '400', winPoints: '0', pointsPerUsdt: '100', startedAt: '2026-08-05T12:44:18+08:00', settledAt: '2026-08-05T12:44:21+08:00', createdAt: '2026-08-05T12:44:18+08:00', updatedAt: '2026-08-05T12:44:21+08:00', status: 'cancelled', statusDescription: '該局在結算前被取消，不形成有效結算。', exceptionReason: 'GGAP 在結算窗口內取消本局。',
    }),
    buildRound({
        roundId: 'round-20260805-0087', externalRoundId: 'ggap-r-3c91aa', gameId: 'mini-burst', gameName: 'Mini Burst', gameType: 'crash', gameVersion: '1.9.2', releaseId: 'rel-20260712-02', agentId: 'agent-b204', agentName: '曜石通路', memberId: 'member-bb08d1', betPoints: '160', winPoints: '160', pointsPerUsdt: '80', startedAt: null, settledAt: '2026-08-05T12:29:03+08:00', createdAt: '2026-08-05T12:28:58+08:00', updatedAt: '2026-08-05T12:29:06+08:00', status: 'rollback', statusDescription: '原已結算，後續依補償流程沖回。', exceptionReason: '結算回呼重複，已依 audit 流程回滾。', retryCount: 1,
    }),
    buildRound({
        roundId: 'round-20260805-0086', externalRoundId: 'ggap-r-1f0e45', gameId: 'slot-orbit', gameName: '星際寶藏', gameType: 'slots', gameVersion: '3.8.1', releaseId: 'rel-20260718-03', agentId: 'agent-a031', agentName: '北辰娛樂代理', memberId: 'member-947ad0', betPoints: '90', winPoints: '0', pointsPerUsdt: '100', startedAt: null, settledAt: '2026-08-05T12:10:14+08:00', createdAt: '2026-08-05T12:10:12+08:00', updatedAt: '2026-08-05T12:10:20+08:00', status: 'failed', statusDescription: '結算流程發生錯誤，等待重試或人工補處理。', exceptionReason: 'Provider settlement callback timeout。', retryCount: 2,
    }),
    buildRound({
        roundId: 'round-20260805-0085', externalRoundId: 'ggap-r-0d631c', gameId: 'slot-crown', gameName: 'Crown of Fortune', gameType: 'slots', gameVersion: '4.1.0', releaseId: 'rel-20260726-04', agentId: 'agent-c118', agentName: '流光遊戲通路', memberId: 'member-1bb8e2', betPoints: '180', winPoints: '360', pointsPerUsdt: '100', startedAt: null, settledAt: '2026-08-04T23:48:39+08:00', createdAt: '2026-08-04T23:48:35+08:00', updatedAt: '2026-08-04T23:48:39+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260804-0084', externalRoundId: 'ggap-r-a08bf2', gameId: 'slot-neon', gameName: 'Neon Fruits', gameType: 'slots', gameVersion: '2.7.5', releaseId: 'rel-20260709-01', agentId: 'agent-b204', agentName: '曜石通路', memberId: 'member-77df08', betPoints: '220', winPoints: '99', pointsPerUsdt: '100', startedAt: null, settledAt: '2026-08-04T22:16:44+08:00', createdAt: '2026-08-04T22:16:41+08:00', updatedAt: '2026-08-04T22:16:44+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260804-0083', externalRoundId: 'ggap-r-92de10', gameId: 'crash-solo', gameName: 'Skyline Crash', gameType: 'crash', gameVersion: '2.4.0', releaseId: 'rel-20260730-01', agentId: 'agent-a031', agentName: '北辰娛樂代理', memberId: 'member-03f19e', betPoints: '600', winPoints: '1320', pointsPerUsdt: '100', startedAt: '2026-08-04T21:40:10+08:00', settledAt: '2026-08-04T21:40:26+08:00', createdAt: '2026-08-04T21:40:10+08:00', updatedAt: '2026-08-04T21:40:26+08:00', status: 'settled', statusDescription: '已完成遊戲結果與點數結算。',
    }),
    buildRound({
        roundId: 'round-20260804-0082', externalRoundId: 'ggap-r-6e40b7', gameId: 'mini-burst', gameName: 'Mini Burst', gameType: 'crash', gameVersion: '1.9.2', releaseId: 'rel-20260712-02', agentId: 'agent-c118', agentName: '流光遊戲通路', memberId: 'member-5f8e11', betPoints: '40', winPoints: '0', pointsPerUsdt: '80', startedAt: null, settledAt: null, createdAt: '2026-08-05T15:23:02+08:00', updatedAt: '2026-08-05T15:23:08+08:00', status: 'processing', statusDescription: '遊戲結果已接收，尚未完成正式結算。',
    }),
]

const sortableFields = new Set([
    'settled_at', 'round_id', 'external_round_id', 'game_id', 'game_name', 'game_type', 'game_version',
    'agent_id', 'agent_name', 'member_id', 'bet_points', 'win_points', 'net_points', 'status',
])

function compareRounds(left: ProviderGameRound, right: ProviderGameRound, field: string, order: 'asc' | 'desc') {
    ...
    if (leftMissing || rightMissing) {
        if (leftMissing && rightMissing) return left.round_id.localeCompare(right.round_id)
        return leftMissing ? 1 : -1
    }

    let comparison = 0
    if (['bet_points', 'win_points', 'net_points'].includes(field)) {
        comparison = new Big(String(leftValue)).cmp(new Big(String(rightValue)))
    } else if (field === 'settled_at' || field === 'created_at' || field === 'updated_at') {
    ...
    if (comparison === 0) return left.round_id.localeCompare(right.round_id)
...
export const providerGameRoundHandlers = [
    http.get('/api/provider/v1/game-rounds', async ({ request }) => {
        ...
        const sortBy = sortableFields.has(url.searchParams.get('sort_by') ?? '') ? url.searchParams.get('sort_by')! : 'settled_at'
        ...
        const to = url.searchParams.get('to') ? new Date(url.searchParams.get('to')!).getTime() : null
        ...
        let filtered = mockGameRounds.filter((round) => {
            ...
            // 未結算資料保留在正式紀錄列表，避免因 settled_at 為空而消失。
            if (round.settled_at) {
        ...
        filtered = filtered.sort((left, right) => compareRounds(left, right, sortBy, sortOrder))
