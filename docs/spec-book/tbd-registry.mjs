...
export const tbdRegistry = [
    ...
    tbd('TBD-DOM-003', 'domain', '遊戲發布組合與生命週期', '產品語意已由 DP03 定義；待將現有 Game、Version、Artifact、Release、Active Release 資料表與 enum 映射至需求基準。', ['Product', 'Game Engineering', 'Backend'], ['game-list', 'game-environments', 'game-settings', 'game-math', 'game-versions', 'game-assets'], ['game-lifecycle'], ['frontend', 'backend', 'qa', 'release'], 'P0', 'partial', '正式 Backend 實作前'),
    ...
    tbd('TBD-DOM-005', 'domain', '官網與大廳發布模型', '產品語意已由 DP04 定義；待將現有 Content Entry、Revision、Published Snapshot、Publish Job、Preview Manifest 與四條獨立發布流映射至實際 Backend。', ['Product', 'Content Operations', 'Frontend', 'Backend'], ['website-banners', 'website-content', 'website-releases', 'lobby-overview', 'lobby-games', 'lobby-management', 'lobby-preview'], ['website-lobby'], ['frontend', 'backend', 'qa'], 'P1', 'definition', '正式 Backend 實作前'),
    ...
    tbd('TBD-DAT-006', 'data', '多語內容、素材與 fallback schema', 'DP04 已固定四語系、欄位政策、fallback 鏈及不可變素材版本語意；待映射實際 schema、格式限制、媒體處理與 renderer 支援。', ['Product', 'Content Operations', 'Frontend', 'Backend'], ['game-assets', 'website-banners', 'website-content', 'website-releases', 'lobby-management', 'lobby-preview'], ['game-lifecycle', 'website-lobby'], ['frontend', 'backend', 'qa'], 'P1', 'definition', '正式內容 API 前'),
    ...
    tbd('TBD-API-005', 'api', '遊戲生命週期與發布 API', '依 DP03 映射 Game、Version、Artifact、三環境 Release、Active Release、風險分類、回滾、全域狀態與 GGAP 投遞的實際 API。', ['Game Engineering', 'Backend', 'Frontend', 'Security'], ['game-list', 'game-environments', 'game-settings', 'game-math', 'game-versions', 'game-assets'], ['game-lifecycle'], ['frontend', 'backend', 'integration', 'qa', 'release'], 'P0', 'definition', 'Portal 原型接正式 API 前'),
    tbd('TBD-API-006', 'api', '官網與遊戲大廳 API', '依 DP04 映射 Entry、Revision、Validation、Preview、Approval、Job、Snapshot、Delivery、DEMO readiness 與 Audit 的實際 API、錯誤及冪等介面。', ['Backend', 'Frontend', 'Content Operations'], ['website-banners', 'website-content', 'website-releases', 'lobby-overview', 'lobby-games', 'lobby-management', 'lobby-demo', 'lobby-preview'], ['website-lobby'], ['frontend', 'backend', 'qa'], 'P1', 'definition', 'Portal 原型接正式 API 前'),
    ...
    tbd('TBD-SEC-003', 'security', '高風險操作、核准、併發與稽核', 'DP03 與 DP04 已採一般一人＋高風險第二人核准，並定義 Revision／Publication conflict 與 append-only audit；待映射實際 permission、approval、lock、audit 及風控操作規則。', ['Product', 'Security', 'Backend', 'SRE'], ['game-environments', 'game-settings', 'game-math', 'game-versions', 'game-assets', 'risk-alerts', 'website-banners', 'website-content', 'website-releases', 'lobby-management'], ['monitoring-risk', 'game-lifecycle', 'website-lobby'], ['frontend', 'backend', 'qa', 'release'], 'P0', 'partial', '高風險操作實作前'),
    ...
    tbd('TBD-SEC-005', 'security', '公開內容、預覽與媒體安全', 'DP04 已定義 sanitize、allowlist、CSP、素材撤銷、短效具 scope 預覽與非匿名分享原則；待映射實際掃描器、token、header、renderer 與安全規則。', ['Security', 'Frontend', 'Backend', 'Content Operations'], ['website-banners', 'website-content', 'lobby-management', 'lobby-preview'], ['website-lobby'], ['frontend', 'backend', 'qa', 'release'], 'P1', 'definition', '正式預覽與公開前'),
