...
assert(['0.13.0-phase-two-seal', '0.14.0-phase-three-pack-01-draft', '0.14.1-phase-three-pack-01-evidence-pending', '0.15.0-phase-three-pack-02-baseline'].includes(book.version), '規格網站版本不得早於 Phase 2 Seal')
assert(['Phase 2 · Draft Sealed', 'Phase 3 · Decision Pack 01 Draft', 'Phase 3 · Pack 01 Backend Evidence Pending', 'Phase 3 · Monitoring & Risk Baseline'].includes(book.status), '規格網站狀態不得早於 Phase 2 Draft Sealed')
